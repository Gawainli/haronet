...
public class ProtobufServer
{
    ...
    public static async void Run()
    {
        ...
        while (true)
        {
            ...
            try
            {
                CreateChannel(new DefaultPkgDecoder(), new DefaultPkgEncoder(), handler);
            }
            catch (Exception e)
            {
                Console.WriteLine(e);
    ...
    private static TcpChannel CreateChannel(INetPackageDecoder decoder, INetPackageEncoder encoder, Socket socket)
    {
